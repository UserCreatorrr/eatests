  ...
  return (
    <div className="p-8">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
        {rows.length === 0 ? (
          <div className="p-12 text-center text-slate-400">Sin albaranes de venta importados</div>
        ) : (
              ...
              <tbody>
                {rows.map((row) => (
                  <tr key={row.id} className="hover:bg-slate-50">
                    ...
                    <td className="px-6 font-semibold text-green-600">{formatCurrency(row.total)}</td>
