...
const fields: FieldDef[] = [
  ...
  { key: 'pending_send', label: 'Pendiente envío', type: 'number' },
  { key: 'pending_receive', label: 'Pendiente recepción', type: 'number' },
...
const columns: ColDef[] = [
  ...
  { label: 'Bloqueado', render: r => r.locked ? <span className="badge badge-red">Sí</span> : <span className="badge badge-gray">No</span> },
]
